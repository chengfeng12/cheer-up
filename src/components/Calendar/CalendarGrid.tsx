            ...
            return (
              <motion.div
                ...
                className={`
                  ...
                  ${
                    isToday
                      ? "bg-emerald-50 dark:bg-emerald-900/20 font-bold text-emerald-600 dark:text-emerald-400"
              ...
              >
                ...
                {checkIn && (
                  ...
                  >
                    ...
                    {!checkIn.mood && (
                      <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full mt-4" />
                    )}
                  </motion.div>
                )}
              </motion.div>
            ...
            >
              ...
              <div>
                ...
                <div className="space-y-3">
                  {getTasksByDate(format(selectedDate, "yyyy-MM-dd")).length >
                  0 ? (
                    getTasksByDate(format(selectedDate, "yyyy-MM-dd")).map(
                      (task) => (
                        <div
                          key={task.id}
